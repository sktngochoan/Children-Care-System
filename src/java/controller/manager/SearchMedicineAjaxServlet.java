 ...
 * @author win
 */
public class SearchMedicineAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchMedicineAjaxServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchMedicineAjaxServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<medicine> listMedicine = new MedicineDAO().getAllMedicineByTxt(txt);
        if(listMedicine == null ||txt.equalsIgnoreCase("")){
            listMedicine = new MedicineDAO().getNext3Medicine(0);
        }
