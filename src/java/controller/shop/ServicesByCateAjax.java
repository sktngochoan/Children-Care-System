 ...
 * @author win
 */
public class ServicesByCateAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServicesByCateAjax</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServicesByCateAjax at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<service> listService = serviceDAO.getAllServicesByCate(cate);
        ...
        for (service s : listService) {
            ...
            out.println("<div class=\"row p-2 bg-white border rounded mt-2\">\n"
