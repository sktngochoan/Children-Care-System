            ...
            <div class="col-12" style="margin-top: 50px">
                ...
                <div class="box">
                    ...
                    <div class="box-body overflow-scroll">
                        ...
                        <button style="width: 100px" type="submit" class="btn btn-success">Completed</button>
                        ...
                        <table style="margin-bottom: 50px;"> 
                            ...
                            <div class="examples"> 
                                <button style="width: 100%;" class="btn btn-lg btn-success sweet-12"><h3>Reservation information: </h3></button> 
                            </div> 
                            <thead>
                                <tr>
                            ...
                            <table> 
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-info">Add Examination</button>
                                    </td>
                                    </tr>
                                    </form> 
                                </c:forEach>
