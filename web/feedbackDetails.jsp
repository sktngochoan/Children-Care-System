            ...
            <section class="breadcrumbs">
                <div class="container">
                    ...
                    <div class="container rounded bg-white mt-5 mb-5">
                        <div class="front">
                            <form action="feedbackdetails?feedback_id=${requestScope.feedback.feedback_id}" method="post">
                                <div class="row">
                                    <div class="col-md-4 border-right">
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><div class="col-md-12">
                                            <label class="labels">
                                                <img class="o rounded-circle mt-5" width="200px" height="200px" src="./resouce/image/${feedback.feedback_image}">
                                    ...
                                    <div class="col-md-7 border-right">
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-12"><label class="labels">Name</label><input readonly name="name" type="text" class="form-control" placeholder="name" value="${requestScope.name}"></div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="col-md-12"><label class="labels">Mobile Number</label><input readonly name="phone" type="text" class="form-control" placeholder="enter phone number" value="${feedback.mobile}"></div>
                                                <div class="col-md-12"><label class="labels">Email</label><input name="email" readonly type="text" class="form-control" placeholder="enter email" value="${feedback.email}"></div>
                                                <div class="col-md-12">
                                                   
                                                    <textarea readonly class="mt-3 mb-3" id="w3review" name="w3review" rows="10" cols="70">${feedback.content}</textarea>
  <br>
                                                </div>
                                                <div class="d-flex flex-row">
                                                    <div class="ratings mr-2 m-3">
