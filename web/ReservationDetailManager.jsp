            ...
            <div class="col-12" style="margin-top: 50px">
                ...
                <div class="box">
                    ...
                    <div class="box-body overflow-scroll">
                        ...
                        <form action="cencalreservation">
                            <input type="hidden" name="res_id" value="${informationReservation.reservation_id}">
                            <textarea name="reason" placeholder="Reason" cols="30" rows="4"></textarea>
                        <br>
                        <button style="width: 100px" type="submit" class="btn btn-danger">Cancel</button>
                        ...
                        <table> 
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.listServiceOfReservation}" var="LR">
                                    <tr>
                                        <td><img src="./resouce/image/service/${LR.image}" width="100px"></td>
                                        <td>
                                            ${LR.service_title}
                                        </td>
                                        ...
                                        <td>
                                            ${LR.service_price * LR.num_of_person}$
                                        </td>
