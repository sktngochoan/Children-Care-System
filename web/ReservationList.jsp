                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <span class="order-status order-ready">${reservation.created_date}</span>
                                            </td>
                                        ...
                                        <td>
                                             ...
                                             <td>
                                                ...
                                                <span class="order-status order-ready">${reservation.num_of_person}</span>
                                            </td>
                                             <td>
                                                
                                                <span class="order-status order-ready">${reservation.total_price}</span>
                                            </td>
                                        ...
                                        <c:if test="${reservation.reservation_status==3}">
                                            <td>
                                            <div class="payment-status payment-cencal">
                                                <div class="dot"></div>
                                                <span>Cancel</span>
                                            </div>
                                        </td>
                                       </c:if>
                                        <c:if test="${reservation.reservation_status==6}">
                                            <td>
                                            <div class="payment-confirm payment-cencal">
                                                <div class="dot"></div>
                                                <span>Confirm</span>
                                            </div>
                                        </td>
                                       </c:if>
                                        <td><button type="button" class="btn btn-success"><a href="/project_swp391/ReservationDetailController1?res_id=${reservation.reservation_id}">Detail</a></button></td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
