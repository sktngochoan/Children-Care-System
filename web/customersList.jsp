    ...
    <body>
            ...
            <section class="breadcrumbs">
                    ...
                    <div class="row">
                        <div class="col-md-3 btn btn-dark " style="text-align: left; height: 710px">
                            <div>
                                ...
                                <nav class="navbar navbar-light bg-light"  style="display: block">
                                    <form action="filltercustomer" class="form-inline">
                            ...
                            <div style="margin-top:15px ">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <form action="filltercustomer" method="get">
                        ...
                        <div class="col-md-8 ">
                            <div class="mb-3">
                                ...
                                <a href="customerList"><button type="button" class="btn btn-dark">CLEAR FILTER</button></a>
                            </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body card__face card__face--front">
                                                ...
                                                <a href="customer_details?user_id=${u.user_id}&function=${func1}" class="btn btn-primary">View User</a>
                                                <a href="customer_details?user_id=${u.user_id}&function=${func2}" class="btn btn-success">Edit User</a>
                                            </div>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a style="pointer-events: ${page == 1?"none":""}" class="page-link" href="customerList?page=${page - 1}" aria-label="Previous">
                        ...
                        <c:if test="${path == home}">
                            <c:forEach begin="1" end="${maxPage}" var="i">
                                <li class="page-item ${i==page?"active":""}"><a class="page-link" href="customerList?page=${i}">${i}</a></li>
                                </c:forEach>
                            </c:if>
                            <c:if test="${path == filter}">
                                <c:forEach begin="1" end="${maxPage}" var="i">
                                <li class="page-item ${i==page?"active":""}"><a class="page-link" href="filltercustomer?page=${i}">${i}</a></li>
                                </c:forEach>
                            </c:if>

                        <li class="page-item">
                            <a style="pointer-events: ${page == maxPage?"none":""}" class="page-link" href="customerList?page=${page + 1}" aria-label="Next">
        ...
        <script>
                                            function searchByName(param) {
                                                ...
                                                $.ajax({
                                                    url: "/project_swp391/searchCustomer",
