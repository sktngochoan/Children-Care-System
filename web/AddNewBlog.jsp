                                ...
                                <div class="row">
                                    <div class="col-md-4 border-right">
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><div class="col-md-12">
                                                <label class="labels">
                                                    ...
                                                    <br/>
                                                    <img class="o rounded-circle mt-5"  width="200px" height="200px" >
                                                    <input hidden="hidden" name="image" type="file" class="form-control" >
                                                </label>
                                            </div></div>
                                    </div>
                                    <div class="col-md-7 border-right">
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-12"><label class="labels">Blog Title:</label><input required  name="title" type="text" class="form-control" placeholder="name" ></div>
                                            </div>
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <br/>
                                                    <textarea required class="mt-3 mb-3" id="w3review" name="bi" rows="7" cols="80"></textarea>
                                                    <br>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <br/>
                                                    <textarea required class="mt-3 mb-3" id="w3review" name="detail" rows="14" cols="80"></textarea>
                                                    <br>
                                                </div>
