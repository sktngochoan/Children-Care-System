                                ...
                                <div id="content" style="padding: 50px 0 0;">
                                    <c:forEach items="${listService}" var="i">
                                        <div class="services row p-2 bg-white border rounded mt-2">
                                            <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image" src="./resouce/image/service/${i.getImage().get(0).getImage_link()}"></div>
                                            <div class="col-md-6 mt-1">
                                                <h5>${i.service_title}</h5>
                                                <div class="d-flex flex-row">
                                                    <div class="ratings mr-2">
                                                        <c:forEach begin="1" end="${i.service_rateStar}">
                                                            <span class="fa fa-star checked"></span>
                                                        </c:forEach>
                                                        <c:forEach begin="1" end="${5-i.service_rateStar}">
                                                            <span class="fa fa-star"></span>
                                                        </c:forEach>
                                                    </div>
                                                    <br>
                                                </div>
                                                <div>${i.service_vote} vote</div>
                                                <div>
                                                    ${i.services_bi}
                                                </div>
                                            </div>
                                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                                <div class="d-flex flex-row align-items-center">
                                                    <h4 class="mr-1">${i.service_discount}</h4><span class="strike-text">${i.service_price}</span>
                                                </div>
                                                    <div class="d-flex flex-column mt-4">
                                                        <button onclick="window.location.href='/project_swp391/service-detail?service_id=${i.service_id}'" class="btn btn-primary btn-sm" type="button">Details Service</button>
                                                        <button onclick="addToCardAsync(${i.service_id})" class="btn btn-outline-primary btn-sm mt-2" type="button">Book Service</button></div>
